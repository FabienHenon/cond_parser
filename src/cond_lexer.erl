...
yystate(31, [10|Ics], Line, Tlen, _, _) ->
    yystate(31, Ics, Line+1, Tlen+1, 11, Tlen);
...
-file("src/cond_lexer.xrl", 14).
yyaction_0(TokenChars, TokenLine) ->
     { token, { arg_float, TokenLine, list_to_float (TokenChars) } } .

-compile({inline,yyaction_1/2}).
-file("src/cond_lexer.xrl", 15).
yyaction_1(TokenChars, TokenLine) ->
     { token, { arg_int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("src/cond_lexer.xrl", 16).
yyaction_2(TokenChars, TokenLine) ->
     { token, { arg_bool, TokenLine, list_to_bool (TokenChars) } } .

-compile({inline,yyaction_3/1}).
-file("src/cond_lexer.xrl", 17).
yyaction_3(TokenLine) ->
     { token, { or_op, TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("src/cond_lexer.xrl", 18).
yyaction_4(TokenLine) ->
     { token, { and_op, TokenLine } } .

-compile({inline,yyaction_5/2}).
-file("src/cond_lexer.xrl", 19).
yyaction_5(TokenChars, TokenLine) ->
     { token, { arg_string, TokenLine, from_double_quoted (TokenChars) } } .

-compile({inline,yyaction_6/2}).
-file("src/cond_lexer.xrl", 20).
yyaction_6(TokenChars, TokenLine) ->
     { token, { arg_string, TokenLine, from_single_quoted (TokenChars) } } .

-compile({inline,yyaction_7/1}).
-file("src/cond_lexer.xrl", 21).
yyaction_7(TokenLine) ->
     { token, { '(', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("src/cond_lexer.xrl", 22).
yyaction_8(TokenLine) ->
     { token, { ')', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("src/cond_lexer.xrl", 23).
yyaction_9(TokenLine) ->
     { token, { equal, TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("src/cond_lexer.xrl", 24).
yyaction_10(TokenLine) ->
     { token, { not_equal, TokenLine } } .

-compile({inline,yyaction_11/0}).
-file("src/cond_lexer.xrl", 25).
yyaction_11() ->
     skip_token .
